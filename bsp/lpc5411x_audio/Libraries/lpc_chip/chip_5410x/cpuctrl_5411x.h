/*
 * @brief LPC5411X CPU multi-core support driver
 *
 * @note
...
#ifndef __CPUCTRL_5411X_H_
#define __CPUCTRL_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup CPUCTRL_5411X CHIP: LPC5411X CPU multi-core support driver
 ...
 * @ref POWER_LIBRARY_5411X library. For more information on using the
 * LPC5411x LPCopen package with multi-core, see @ref CHIP_5411X_MULTICORE<br>.
 * @{
 */
