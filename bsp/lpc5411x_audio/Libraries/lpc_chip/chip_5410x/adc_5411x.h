...
#ifndef __ADC_5411X_H_
#define __ADC_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup ADC_5411X CHIP:  LPC5411X A/D conversion driver
 ...
 * @param	pADC	: The base of ADC peripheral on the chip
 * @return	LPC_OK on success, ERR_TIME_OUT or ERR_ADC_NO_POWER on failure
...
__STATIC_INLINE void Chip_ADC_SetThresholdInt(LPC_ADC_T *pADC, uint8_t ch, ADC_INTEN_THCMP_T thInt)
{
	...
	Chip_ADC_DisableInt(pADC, (ADC_INTEN_CMP_MASK << shiftIndex));
...
/**
 * @brief	Set Threshold selection bits
 * @param	pADC	: The base of ADC peripheral on the chip
 * @param	mask	: Threshold selection mask
 * @return  Nothing
 */
...
/**
 * @brief	Clear Threshold selection bits
 * @param	pADC	: The base of ADC peripheral on the chip
 * @param	mask	: Threshold selection mask
 * @return  Nothing
 */
