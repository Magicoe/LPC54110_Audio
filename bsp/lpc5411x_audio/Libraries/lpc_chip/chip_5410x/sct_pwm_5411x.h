/*
 * @brief LPC5411x State Configurable Timer (SCT/PWM) Chip driver
 *
 * @note
...
#ifndef __SCT_PWM_5411X_H_
#define __SCT_PWM_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup SCT_PWM_5411X CHIP: LPC5411X State Configurable Timer PWM driver
 *
