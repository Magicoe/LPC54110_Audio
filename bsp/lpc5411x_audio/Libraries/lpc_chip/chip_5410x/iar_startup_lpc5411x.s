;/*****************************************************************************
; * @file:    startup_LPC5411x.s
; * @purpose: CMSIS Cortex-M4/M0+ Core Device Startup File
; *           for the NXP LPC5411x Device Series (manually edited)
; * @version: V1.00
...
__vector_table_0x1c
        ...
        DCD     IOH_IRQHandler            ; IOH Handler
        ...
        DCD     SPIFI_IRQHandler          ; SPIFI Interface
__Vectors_End
...
Reserved_IRQHandler
        ...
        PUBWEAK     WDT_BOD_IRQHandler        ; Watchdog Ored with BOD
        ...
        PUBWEAK     FLEXCOMM0_IRQHandler      ; FLEXCOMM0
        PUBWEAK     FLEXCOMM1_IRQHandler      ; FLEXCOMM1
        PUBWEAK     FLEXCOMM2_IRQHandler      ; FLEXCOMM2
        PUBWEAK     FLEXCOMM3_IRQHandler      ; FLEXCOMM3
        PUBWEAK     FLEXCOMM4_IRQHandler      ; FLEXCOMM4
        PUBWEAK     FLEXCOMM5_IRQHandler      ; FLEXCOMM5
        PUBWEAK     FLEXCOMM6_IRQHandler      ; FLEXCOMM6
        PUBWEAK     FLEXCOMM7_IRQHandler      ; FLEXCOMM7
        ...
        PUBWEAK     DMIC_IRQHandler           ; Digital MIC
        PUBWEAK     HWVAD_IRQHandler          ; Voice Activity detect
        PUBWEAK     USB_NEEDCLK_IRQHandler    ; USB NeedCLK
        PUBWEAK     USB_IRQHandler            ; USB
        PUBWEAK     RTC_IRQHandler            ; RTC Timer
        PUBWEAK     IOH_IRQHandler            ; IOH Handler
        ...
        PUBWEAK     SPIFI_IRQHandler          ; SPIFI Interface
...
SPIFI_IRQHandler          ; SPIFI Interface
