/*
 * @brief LPC5411X WWDT chip driver
 *
 * @note
...
#ifndef __WWDT_5411X_H_
#define __WWDT_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup LPC_WWDT CHIP: LPC5411X Windowed Watchdog driver
