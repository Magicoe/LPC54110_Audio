/*
 * @brief LPC5411X IOCON register block and driver
 *
 * @note
...
#ifndef __IOCON_5411X_H_
#define __IOCON_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup IOCON_5411X CHIP: LPC5411X IOCON register block and driver
 * @ingroup CHIP_5411X_DRIVERS
 * @{
 */

/**
 * @brief LPC5411X IO Configuration Unit register block structure
 */
typedef struct {			/*!< LPC5411X IOCON Structure */
