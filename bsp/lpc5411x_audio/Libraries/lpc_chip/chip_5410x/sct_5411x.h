/*
 * @brief LPC5411X State Configurable Timer (SCT) Chip driver
 *
 * @note
...
#ifndef __SCT_5411X_H_
#define __SCT_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup SCT_5411X CHIP: LPC5411X State Configurable Timer driver
