...
#ifndef __GPIO_5411X_H_
#define __GPIO_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup GPIO_5411X CHIP: LPC5411X GPIO driver
 ...
 * @param	pGPIO	: The base of GPIO peripheral on the chip (not used)
 * @return	Nothing
 * @note	@a pGPIO parameter is ignored and all available GPIOs
 * will be turned on by default.
 */
__STATIC_INLINE void Chip_GPIO_Init(LPC_GPIO_T *pGPIO)
{
 ...
 * @return	Nothing
 */
__STATIC_INLINE void Chip_GPIO_DeInit(LPC_GPIO_T *pGPIO)
{
 ...
 * of this function.
 */
__STATIC_INLINE void Chip_GPIO_WriteDirBit(LPC_GPIO_T *pGPIO, uint32_t port, uint8_t pin, bool setting)
{
	if (setting) {
 ...
 * @return	Nothing
 */
__STATIC_INLINE void Chip_GPIO_SetPinDIR(LPC_GPIO_T *pGPIO, uint8_t port, uint8_t pin, bool output)
{
	if (output) {
 ...
 */
__STATIC_INLINE void Chip_GPIO_SetDir(LPC_GPIO_T *pGPIO, uint8_t portNum, uint32_t bitValue, uint8_t out)
{
	if (out) {
